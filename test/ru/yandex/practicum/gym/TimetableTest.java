...
public class TimetableTest {
    ...
    void testAddNewTrainingSessionForWeak(){
        ...
        TrainingSession singleTrainingSession3 = new TrainingSession(group, coach,
                DayOfWeek.WEDNESDAY, new TimeOfDay(13, 0));
        TrainingSession singleTrainingSession4 = new TrainingSession(group, coach,
                DayOfWeek.THURSDAY, new TimeOfDay(13, 0));
        TrainingSession singleTrainingSession5= new TrainingSession(group, coach,
                DayOfWeek.FRIDAY, new TimeOfDay(13, 0));
        TrainingSession singleTrainingSession6 = new TrainingSession(group, coach,
                DayOfWeek.SATURDAY, new TimeOfDay(13, 0));
        TrainingSession singleTrainingSession7 = new TrainingSession(group, coach,
    ...
    void testGetTrainingSessionsForDayMultipleSessions() {
        ...
        Assertions.assertEquals(thursdayChildTrainingSession.getTimeOfDay(),
                timetable.getTrainingSessionsForDay(DayOfWeek.THURSDAY).getFirst().getFirst().getTimeOfDay());
        Assertions.assertEquals(thursdayAdultTrainingSession.getTimeOfDay(),
                timetable.getTrainingSessionsForDay(DayOfWeek.THURSDAY).getLast().getFirst().getTimeOfDay());
    }
